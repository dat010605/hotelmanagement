...
const LOCAL_GUIDES_DATA = [
  { id: 'g1', titleKey: 'attractionsPage.hoian_title', title: 'Phố cổ Hội An', categoryKey: 'attractionsPage.catHeritage', category: 'Di sản', descKey: 'attractionsPage.hoian_desc', desc: 'Khu phố cổ được bảo tồn tuyệt đẹp từ thế kỷ 15 đến 19.', fullContentKey: 'attractionsPage.hoian_full', img: 'https://images.unsplash.com/photo-1559592413-7cec4d0cae2b?w=600', distance: '5 km', durationKey: 'attractionsPage.hoian_duration', duration: 'Nửa ngày', rating: 4.9, tagsKey: 'attractionsPage.hoian_tags', tags: ['Lịch sử', 'Kiến trúc', 'Đèn lồng'], mapUrl: '', location: 'Đà Nẵng', lat: 15.8801, lng: 108.3380 },
  { id: 'g2', titleKey: 'attractionsPage.bana_title', title: 'Bà Nà Hills', categoryKey: 'attractionsPage.catEntertainment', category: 'Giải trí', descKey: 'attractionsPage.bana_desc', desc: 'Tổ hợp vui chơi giải trí trên đỉnh núi mờ sương.', fullContentKey: 'attractionsPage.bana_full', img: 'https://images.unsplash.com/photo-1592898741994-2189e4f5e354?w=600', distance: '25 km', durationKey: 'attractionsPage.bana_duration', duration: '1 ngày', rating: 4.8, tagsKey: 'attractionsPage.bana_tags', tags: ['Cáp treo', 'Cầu Vàng', 'Công viên'], mapUrl: '', location: 'Đà Nẵng', lat: 15.9961, lng: 107.9880 },
  { id: 'g3', titleKey: 'attractionsPage.mykhe_title', title: 'Biển Mỹ Khê', categoryKey: 'attractionsPage.catNature', category: 'Thiên nhiên', descKey: 'attractionsPage.mykhe_desc', desc: 'Một trong những bãi biển quyến rũ nhất hành tinh.', fullContentKey: 'attractionsPage.mykhe_full', img: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=600', distance: '1 km', durationKey: 'attractionsPage.mykhe_duration', duration: 'Vài giờ', rating: 4.7, tagsKey: 'attractionsPage.mykhe_tags', tags: ['Biển xanh', 'Tắm nắng', 'Hải sản'], mapUrl: '', location: 'Đà Nẵng', lat: 16.0610, lng: 108.2483 },
  { id: 'g4', titleKey: 'attractionsPage.marble_title', title: 'Ngũ Hành Sơn', categoryKey: 'attractionsPage.catSpiritual', category: 'Tâm linh', descKey: 'attractionsPage.marble_desc', desc: 'Quần thể 5 ngọn núi đá vôi với hệ thống hang động huyền bí.', fullContentKey: 'attractionsPage.marble_full', img: 'https://images.unsplash.com/photo-1583417319070-4a69db38a482?w=600', distance: '8 km', durationKey: 'attractionsPage.marble_duration', duration: 'Nửa ngày', rating: 4.6, tagsKey: 'attractionsPage.marble_tags', tags: ['Hang động', 'Chùa chiền', 'Điêu khắc đá'], mapUrl: '', location: 'Đà Nẵng', lat: 16.0028, lng: 108.2618 },
  { id: 'g_vt1', title: 'Công viên Tropicana', category: 'Điểm tham quan', desc: 'Công viên giải trí nước kết hợp các trò chơi cảm giác mạnh mang phong cách nhiệt đới tại Hồ Tràm, Vũng Tàu.', img: 'https://images.unsplash.com/photo-1571431604928-85472ff2e4ec?w=600', distance: 'Gần Vũng Tàu', duration: '1 ngày', rating: 4.8, tags: ['Giải trí', 'Công viên nước'], mapUrl: '', location: 'Vũng Tàu', lat: 10.4682, lng: 107.4526 },
  { id: 'g_vt2', title: 'Bảo tàng Vũ khí cổ Robert Taylor', category: 'Điểm tham quan', desc: 'Bộ sưu tập vũ khí cổ khổng lồ từ khắp nơi trên thế giới được trưng bày trong không gian cổ kính.', img: 'https://images.unsplash.com/photo-1555949258-eb67b1ef0ceb?w=600', distance: 'Trung tâm Vũng Tàu', duration: '2 giờ', rating: 4.7, tags: ['Bảo tàng', 'Lịch sử'], mapUrl: '', location: 'Vũng Tàu', lat: 10.3458, lng: 107.0765 },
  { id: 'g_vt3', title: 'Tượng Chúa Giêsu Kytô Vua', category: 'Điểm tham quan', desc: 'Tượng Chúa dang tay ngoạn mục nằm trên đỉnh Núi Nhỏ của thành phố biển Vũng Tàu.', img: 'https://images.unsplash.com/photo-1583417319070-4a69db38a482?w=600', distance: 'Núi Nhỏ', duration: 'Nửa ngày', rating: 4.9, tags: ['Biểu tượng', 'Kiến trúc', 'Ngắm cảnh'], mapUrl: '', location: 'Vũng Tàu', lat: 10.3275, lng: 107.0850 },
  { id: 'g_hn1', title: 'Hồ Hoàn Kiếm', category: 'Di sản', desc: 'Biểu tượng lịch sử thiêng liêng giữa lòng thủ đô Hà Nội ngàn năm văn hiến.', img: 'https://images.unsplash.com/photo-1599708155013-176313f8d32d?w=600', distance: 'Trung tâm Hà Nội', duration: 'Nửa ngày', rating: 4.9, tags: ['Biểu tượng', 'Lịch sử', 'Đi dạo'], mapUrl: '', location: 'Hà Nội', lat: 21.0285, lng: 105.8523 },
  { id: 'g_hcm1', title: 'Chợ Bến Thành', category: 'Di sản', desc: 'Biểu tượng lịch sử lâu đời, nơi hội tụ tinh hoa ẩm thực Sài Gòn và là điểm mua sắm sầm uất.', img: '/attractions/ben_thanh_market.png', distance: 'Quận 1', duration: 'Vài giờ', rating: 4.6, tags: ['Mua sắm', 'Ẩm thực', 'Lịch sử'], mapUrl: '', location: 'Hồ Chí Minh', lat: 10.7725, lng: 106.6980 }
];
  ...
  return (
    <div style={{ paddingBottom: 60 }}>
      <div style={{
        ...
        padding: "0 40px",
        backgroundImage: "url(https://images.unsplash.com/photo-1544161515-4ab6ce6db874?w=1600)",
